...
\inred{
\subsection{Approximated solution for the Diaboloid}
}
...
% (Eq.(12) in Ref.~\cite{Valeriy2020b}):
...
% An equivalent form was also deduced in eq. 12 of  Ref.~\cite{Goldberg2020}:
% \begin{multline}
...
\subsection{Exact solution for the diaboloid}
\inred{
...
\subsection{Parabolic-\inred{quasi}cone}
...
% evaluate at x=0 this: https://www.wolframalpha.com/input/?i=series+%5B2+p+%28q+-+x+C%29+S+C+sqrt%28x+C+%2F+p+%2B+C%5E2%29+%2F+%28p%2Bq%29%2C+x%5D
\begin{equation}
...
% \begin{equation}
% \label{eq:sagittalRadiusLinearized2}
