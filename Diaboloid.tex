...
% \usepackage{hyperref} %GIVE PROBLEMS: REMOVES Figure XX LABEL!!!!!
% \usepackage{url}
...
\aff[b]{European Synchrotron Radiation Facility, 71 Avenue des Martyrs F-38000 Grenoble, France}
...
% \caption{
% Schematic (vertical section) of the reference frames: mirror-related $(X,Y,Z)$ used for numerical implementation, and mirror-canonical $(x,y,z)$ where the diaboloid shape takes the form of equation~(\ref{eqn:diaboloidV}). }
% \end{figure}
...
%\inred{\sout{, more precise at a first view,}} 
